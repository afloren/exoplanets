...
const skyVertexShader = [
    ...
    '	vSunDirection = normalize( (viewMatrix * vec4( sunPosition, 1.0 )).xyz );',
...
const skyFragmentShader = [
    ...
    '   float sunAmount = clamp( pow( 1.0 - dot( up, vSunDirection ), 5.0 ), 0.0, 1.0 );',
    '   vec3 betaRatio = ( betaRTheta + betaMTheta ) / ( vBetaR + vBetaM );',
    '	Lin *= mix( vec3( 1.0 ), pow( vSunE * ( betaRatio ) * Fex, vec3( 1.0 / 2.0 ) ), sunAmount );',
    ...
    '	gl_FragColor = vec4( retColor, abs(retColor) );',
            ...
            >                               
                <mesh>
                    ...
                    <shaderMaterial 
                        ...
                        uniforms={this.state.skyUniforms}
                        transparent={true}
                        side={BackSide}
                    />
                </mesh>
